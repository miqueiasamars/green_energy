    ...
    <Layout> 
      ...
      <div className="flex justify-end">
        <div className=" rounded-lg border border-[#e9e7e7] px-6 py-6 sobra bg-white md:max-w-md">
          ...
          <div className="pt-4 text-lg"><h2>Os pellets são formados por resíduos de madeira prensados em formato cilíndrico, que possuem entre 6 e 8 milímetros <a className="underline cursor-pointer" href="/produtos">Saiba mais...</a></h2></div>
      ...
      <div className="flex justify-start">
        <div className="rounded-lg border border-[#e9e7e7] px-6 py-6 sobra bg-white md:max-w-md">
          ...
          <div className="pt-4 text-lg"><h2>Os pellets são utilizados como geradores de calor, energia e solução higiênica para animais. Podendo ser utilizados <a className="underline cursor-pointer" href="/produtos">Saiba mais...</a></h2></div>
      ...
      <div className="flex justify-end">
        <div className="rounded-lg border border-[#e9e7e7] px-6 py-6 sobra bg-white md:max-w-md"> 
          ...
          <div className="pt-4 text-lg"><h2>Ao comprar pellets, o comprador deve estar atento a certificação que garante a procedência do produto tanto pela <a className="underline cursor-pointer" href="/produtos">Saiba mais...</a></h2></div>
      ...
      <div className="flex justify-start">
        <div className="rounded-lg border border-[#e9e7e7] px-6 py-6 sobra bg-white md:max-w-md">
          ...
          <div className="pt-4 text-lg"><h2>A primeira vantagem envolve a matéria-prima, que apresenta uma grande disponibilidade e versatilidade. A matéria-prima <a className="underline cursor-pointer" href="/produtos">Saiba mais...</a></h2></div>
      ...
      <div className="text-2xl font-semibold">Notícias Recentes</div>
